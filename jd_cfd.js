...
$.InviteList = []
$.innerInviteList = [];
const HelpAuthorFlag = flash;//是否助力作者SH  true 助力，false 不助力
...
`)
  ...
  $.InviteLists = []
  if (HelpAuthorFlag) {
    $.innerInviteList = await getAuthorShareCode('https://raw.fastgit.org/a592345029/backup/main/cfd.json');
    res2 = await getAuthorShareCode('https://raw.fastgit.org/a592345029/backup/main/cfd.json');
